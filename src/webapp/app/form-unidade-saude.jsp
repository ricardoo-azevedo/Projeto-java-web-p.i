	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
					...
					<div class="col-md-7">
						...
						if(request.getParameter("exibirAlertUS") != null){	
							...
							<div class="alert alert-success alert-dismissible fade show" role="alert" id="alertUS">
							  Unidades de Saúde <%= nomeUS %> modificada!
						...
						<h1 class="mt-4">Unidades de Saúde</h1>
						...
						<div class="table-overflow mt-4">
	                      <table class="table table-bordered table-light table-striped table-hover" style="border-radius: 8px;">
						    ...
						    List<Familia> listaF = iFamilia.listar();
						   ...
						   MedicoInterface iMedico = new MedicoDAO();
						    List<Medico> listaM = iMedico.listarMedico();
						   ...
						   List<Paciente> listaP = iPaciente.listar();
						   ...
						   %>
						      ...
						      <tr>
						        ...
						        <td style="text-align: center;">
						          <a href="controle.jsp?op=3&id=<%= lista.get(i).getId() %>"><img src="./assets/lata.svg" alt="Excluir" width="25" height="25 "></a>
						        </td>
						      </tr>
						      <%
						      }
            ...
            <div class="card mt-3 p-3">
                <i class="icon bi bi-hospital-fill text-primary text-center fs-3"> Unidades de saúde </i>
            ...
            <div class="card mt-3 p-3  ">
                ...
                <div class="count text-danger text-center fs-1"><%= listaP.size() %></div>
            </div>
            <div class="card mt-3 p-3 ">
                <i class="icon bi bi-people-fill text-warning text-center fs-3"> Familias</i>
                <div class="count text-warning text-center fs-1"><%= listaF.size() %></div>
            </div>
            <div class="card mt-3 p-3 ">
                <i class="  icon  bi bi-person-plus-fill text-success text-center fs-3"> Médicos</i>
                <div class="count text-success text-center fs-1"><%=  listaM.size() %></div>
            </div>
